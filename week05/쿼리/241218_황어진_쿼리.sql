...
--
---- 데이터 삽입
INSERT INTO Employees0 (EmployeeID, Name, BirthDate, DepartmentInfo, Salary)
...
INSERT INTO Employees1 (EmployeeID, Name, BirthDate, DepartmentInfo,address,postNo, Salary)
VALUES (1, '스티븐', TO_DATE('2010-12-31', 'YYYY-MM-DD'), '영업부', '서울시..', '01234', 300);
...
CREATE TABLE Employees2a (
    EmployeeID NUMBER PRIMARY KEY,
    Name VARCHAR2(50),
    BirthDate DATE,
    Salary NUMBER
);
CREATE TABLE Employees2b (
    DepartmentInfo VARCHAR2(255) PRIMARY KEY,
    address VARCHAR2(255),
    postNo NUMBER
);

INSERT INTO Employees2a (EmployeeID, Name, BirthDate, Salary)
VALUES (1, '스티븐', TO_DATE('2010-12-31', 'YYYY-MM-DD'), 300);

INSERT INTO Employees2a (EmployeeID, Name, BirthDate, Salary)
VALUES (2, '마리', TO_DATE('2011-10-01', 'YYYY-MM-DD'), 250);

INSERT INTO Employees2a (EmployeeID, Name, BirthDate, Salary)
VALUES (3, '찰스', TO_DATE('2003-05-01', 'YYYY-MM-DD'), 200);

INSERT INTO Employees2a (EmployeeID, Name, BirthDate, Salary)
VALUES (4, '마리아', TO_DATE('1995-08-15', 'YYYY-MM-DD'), 280);

INSERT INTO Employees2a (EmployeeID, Name, BirthDate, Salary)
VALUES (5, '제임스', TO_DATE('1988-03-22', 'YYYY-MM-DD'), 320);

INSERT INTO Employees2a (EmployeeID, Name, BirthDate,Salary)
VALUES (6, '안나', TO_DATE('2000-12-10', 'YYYY-MM-DD'), 270);

SELECT * FROM Employees2a;



INSERT INTO Employees2b (DepartmentInfo, address, postNo)
VALUES ('영업부', '서울시..', '01234');

INSERT INTO Employees2b (DepartmentInfo, address, postNo)
VALUES ('사업부', '경기도...','02345');

INSERT INTO Employees2b (DepartmentInfo, address, postNo)
VALUES ('인사부', '서울시..', '01234');

SELECT * FROM Employees2b;


---------------------------------------------------------------------------------------------------

CREATE TABLE Employees3a (
    EmployeeID NUMBER PRIMARY KEY,
    Name VARCHAR2(50),
    BirthDate DATE,
    DepartmentID NUMBER,
    Salary NUMBER,
	CONSTRAINT fk_DepartmentID3a FOREIGN KEY (DepartmentID) REFERENCES Employees3b (DepartmentNumber)

);
CREATE TABLE Employees3b (
    DepartmentNumber number PRIMARY KEY,
    deparmentName VARCHAR2(255),
    addressNumber NUMBER,
    CONSTRAINT fk_address3b FOREIGN KEY (addressNumber) REFERENCES Employees3c (addressNo)
);
CREATE TABLE Employees3c (
    addressNo NUMBER PRIMARY KEY,
    address VARCHAR2(255),
    postNo NUMBER
);


INSERT INTO Employees3a (EmployeeID, Name, BirthDate, DepartmentID,Salary)
...
INSERT INTO Employees3a (EmployeeID, Name, BirthDate, DepartmentID,Salary)
VALUES (4, '마리아', TO_DATE('1995-08-15', 'YYYY-MM-DD'),4, 280);

INSERT INTO Employees3a (EmployeeID, Name, BirthDate, DepartmentID,Salary)
VALUES (5, '제임스', TO_DATE('1988-03-22', 'YYYY-MM-DD'),5, 320);

INSERT INTO Employees3a (EmployeeID, Name, BirthDate, DepartmentID,Salary)
VALUES (6, '안나', TO_DATE('2000-12-10', 'YYYY-MM-DD'),6, 270);



INSERT INTO Employees3b (DepartmentNumber, deparmentName, addressNumber)
VALUES (1, '사업부', 1);
...
INSERT INTO Employees3c (addressNo, address, postNo)
VALUES (1, '서울시', 01234);
